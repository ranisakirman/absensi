<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
      ...
      $query = "INSERT INTO jadwal( id_kelas, kode_mk, prodi, hari, jam_mulai, jam_selesai ) VALUES ('$kelas','$matkul','$prodi','$hari','$jam_mulai','$jam_selesai')";
                          ...
                          <div class="col-md-6">
                            ...
                            <?php
                                ...
                                while ($data_matkul = mysqli_fetch_array($matkul)) {
                                    echo "<option value='" . $data_matkul['kode_mk'] . "'>" . $data_matkul['nama_matkul'] . "</option>";
                                }
                            ?>
                        </select>
                          </div>
