<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
      ...
      $query = "INSERT INTO dosen(nip,nama, jenis_kelamin, homebase ) VALUES ('$nip','$nama','$jenis_kelamin','$homebase')";
            ...
            <div class="card-body">
              ...
              <form action="" method="post">
                ...
                <fieldset class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="homebase" id="trpl" value="TRPL" required>
                      <label class="form-check-label" for="gridRadios1">
                        Teknik Rekayasa Perangkat Lunak
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="homebase" id="mi" value="MI" required>
                      <label class="form-check-label" for="gridRadios2">
                        Manajemen Informatika
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="homebase" id="tkom" value="TKOM" required>
                      <label class="form-check-label" for="gridRadios2">
                        Teknik Komputer
                      </label>
                    </div>
