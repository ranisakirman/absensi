<?php
    ...
    $query = "SELECT k.tanggal, j.hari, CONCAT(j.jam_mulai, ' - ', j.jam_selesai) AS waktu,j.kode_mk,k.keterangan FROM kehadiran k JOIN jadwal j ON k.id_jadwal=j.id WHERE k.id_mhs='$nim' ORDER BY k.tanggal DESC,waktu DESC;";
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 text-align="center">Riwayat Presensi</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
          <li class="breadcrumb-item ">Laporan Kehadiran</li>
    ...
    ?>
    <section class="presensi-history">
    <div class="presensi-entry">
        <div class="info-table">
            <div class="info-row">
                <span class="info-label">Tanggal:</span>
                <span class="info-value"><?= $row['tanggal']?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Hari:</span>
                <span class="info-value"><?= $row['hari']?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Waktu:</span>
                <span class="info-value"><?= $row['waktu']?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Kode MK:</span>
                <span class="info-value"><?= $row['kode_mk']?></span>
            </div>
            <div class="info-row">
                ...
                ?>
                <span class="status <?= $statusClass ?>"><?= $row['keterangan']?></span>
            </div>
        </div>
    </div>
</section>
