...
$queryMatkul = "SELECT COUNT(*) as total_matkul FROM matkul";
$resultMatkul = mysqli_query($db, $queryMatkul);

// Hitung jumlah ruang
$queryRuang = "SELECT COUNT(*) as total_ruang FROM ruang";
$resultRuang = mysqli_query($db, $queryRuang);

// Inisialisasi jumlah mahasiswa dan dosen dan matkul
$jumlah_mahasiswa = 0;
$jumlah_dosen = 0;
$jumlah_matkul = 0;
$jumlah_ruang = 0;

// Periksa apakah query mahasiswa berhasil dijalankan
if ($resultMahasiswa) {
    $rowMahasiswa = mysqli_fetch_assoc($resultMahasiswa);
    $jumlah_mahasiswa = $rowMahasiswa['total_mahasiswa'];
} else {
...
if ($resultDosen) {
    ...
    $jumlah_dosen = $rowDosen['total_dosen'];
} else {
    echo "Error: " . mysqli_error($db);
}

// Periksa apakah query mata kuliah berhasil dijalankan
if ($resultMatkul) {
  $rowMatkul = mysqli_fetch_assoc($resultMatkul);
  $jumlah_matkul = $rowMatkul['total_matkul'];
} else {
  echo "Error: " . mysqli_error($db);
}
...
if ($resultRuang) {
  ...
  $jumlah_ruang = $rowRuang['total_ruang'];
} else {
  echo "Error: " . mysqli_error($db);
}
...
<main id="main" class="main">
  ...
  <table >
              ...
              <div class="card info-card sales-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                    <h6><?php echo $jumlah_mahasiswa; ?></h6>
    ...
    <tr>
      <th>
            <!-- Sales Card -->
              ...
              <div class="card info-card sales-card">
                <div class="card-body">
                  <h5 class="card-title">Ruangan</span></h5>
    ...
    <tr>
      ...
      <button type="button" class="btn btn-warning" onclick="window.location.href='modul/absensi/halaman-presensi.php'">Ambil Absen <i class="bi bi-arrow-right"></i></button>
      </div>
      <?php } ?>
      </th>
    </tr>
